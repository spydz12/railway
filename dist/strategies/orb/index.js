...
const log = (0, logger_1.createComponentLogger)('strategy:orb');
const debug = config_1.config.scanner.debugSignals;
class ORBStrategy {
    constructor() {
        this.slug = 'orb_breakout';
    ...
    isConsolidating(candles, openingRange) {
        if (candles.length < 3)
            return false;
    ...
    findBreakout(candles, openingHigh, openingLow) {
